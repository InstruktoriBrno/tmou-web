...
CREATE TABLE level (
    ...
    needed_correct_answers INT NOT NULL,
    INDEX idx_event_id (event_id),
    UNIQUE INDEX unique_level_number_in_event (event_id, level_number),
    PRIMARY KEY(id)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
ALTER TABLE level ADD CONSTRAINT fk_event_id FOREIGN KEY (event_id) REFERENCES event (id);
EOD);
        // Add puzzles table
        $this->addSql(<<<EOD
CREATE TABLE puzzle (
...
ALTER TABLE puzzle ADD CONSTRAINT fk_level_id FOREIGN KEY (level_id) REFERENCES level (id);
EOD);
        // Add passwords table
        $this->addSql(<<<EOD
...
ALTER TABLE password ADD CONSTRAINT fk_puzzle_id FOREIGN KEY (puzzle_id) REFERENCES puzzle (id);
EOD);
        // Add answers table
        $this->addSql(<<<EOD
CREATE TABLE answer (
    ...
    answer_timestamp DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)',
    INDEX idx_puzzle_id (puzzle_id),
    INDEX idx_team_id (team_id),
    PRIMARY KEY(id)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
ALTER TABLE answer ADD CONSTRAINT fk_puzzle_id FOREIGN KEY (puzzle_id) REFERENCES puzzle (id);
ALTER TABLE answer ADD CONSTRAINT fk_team_id FOREIGN KEY (team_id) REFERENCES team (id);
EOD);
        ...
        $this->addSql('ALTER TABLE team ADD CONSTRAINT fk_current_level_id FOREIGN KEY (current_level_id) REFERENCES level (id);');
